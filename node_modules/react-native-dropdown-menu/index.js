...
import {View, Text, TouchableHighlight, Image, TouchableOpacity, ScrollView, Animated, Easing, StyleSheet,Model} from 'react-native';
  ...
  renderActivityPanel() {
    ...
    <View style={{opacity: 0.4, backgroundColor: 'black', flex: 1 }} />
      ...
      <ScrollView style={[{position: 'absolute', top: 0, left: 0, right: 0, backgroundColor: 'white'}, heightStyle]} >
      {
        ...
        <TouchableOpacity key={index} activeOpacity={1} style={{flex: 1, height: 45}} onPress={this.itemOnPress.bind(this, index)} >
